...
def make_secondaries(center_of_masses, companion_mass, semimajor_axis, eccentricity):
...
def new_argument_parser():
    ...
    parser.add_argument(
        ...
        help="mass for binary component",
    )
    parser.add_argument(
        "--name",
        default="star",
        help="name the newly added companion star",
    )
    parser.add_argument(
        "--host_name",
        default="star",
...
def main():
    ...
    selected_stars = bodies[bodies.name == args.host_name]
