...
_lunar_data = [
    ...
    ["Neptune", "Neso",	       20, 30, 50258000., 0.4243, 86.441, 260.648, 131.265, 49.151], 	
     ["Pluto", "Charon",       20, 30, 19591.,	0.0002,	146.106,131.070,0.080,26.928], 	 	
      ["Pluto", "Nix",         20, 30, 48671.,	0.0000,	324.463,284.405,0.000,203.400], 		
    ["Pluto", "Hydra",         20, 30, 64698.,	0.0056,	153.307,326.678,0.304,113.173], 	 	
    ["Pluto", "Kerberos",      20, 30, 57729.,	0.0000,	160.629,161.061,0.426,305.871], 		
    ["Pluto", "Styx",          20, 30, 42393.,	0.0006,	330.244,194.546,0.080,26.956] 	
] 
...
def add_moons_to_planets(solar_system, time_JD=2457099.5|units.day):
  """
...
if __name__ in ('__main__', '__plot__'):
    ...
    sun_and_planets = read_set_from_file(o.filename, 'hdf5', close_file=True)

    Julian_date = sun_and_planets.Julian_date

    solar_system = add_moons_to_planets(sun_and_planets, Julian_date)
    print(solar_system)
