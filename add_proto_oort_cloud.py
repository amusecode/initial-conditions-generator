...
def ecc_random_power_within_peri_range(n, semi, min_peri, max_peri, power=2.):
  """
  random distribution in eccentricity P(e)~e
  (power = actual_exponent + 1)
  with minimum pericenter of min_peri
...
class SphericalIsotropicCloudWithPlanets(object):
  ...
  def new_model(self): 
    ...
    ecc = ecc_random_power_within_peri_range(self.targetN, a,
                                             self.q_min,
                                             self.q_max,
                                             power=2.)
...
def generate_initial_oort_cloud(m_star, n_comets, q_min, q_max,
                                a_min, a_max, seed):
  """
...
def generate_primordial_oort_cloud(m_star, n_comets, q_min, q_max,
                                   a_min, a_max, seed):
  """
...
if __name__ in ('__main__', '__plot__'):
    ...
    for si in selected_stars:
        ...
        comets = add_comets(si, m_comets, n_comets, o.q_min, o.q_max,
